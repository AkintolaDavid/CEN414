...
function displayCalendar() {
  ...
  highlightedDates = {
    "My Birthday": [5, 5],
    "Daddy's Birthday": [7, 7],
    "Mummy's Birthday": [3, 24],
    "Christmas": [11, 24],
    "Boxing Day": [11, 25],
    "New Year": [0, 0],
  ...
  for (let key in highlightedDates) {
    let colour;
    if (key === "My Birthday") {colour = "red";
    } else if (key === "Mummy's Birthday") {colour = "green";
    } else if (key === "Daddy's Birthday") {colour = "purple";
    } else {
      colour = "yellow";
    }
